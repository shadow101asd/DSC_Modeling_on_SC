...
M = 4;
W = -7; % Could be better to flip the sign convention here out of convenience... todo?
E = 0;
...
Ki = [aF, eF, 0, 0, pi/2, 0];
XSats = NSATSpropagateFromKeplerians_2DFlower_Es(Ki,Nsats,W,M,E,etR,muSu,emin,emax,"trapezoid");
