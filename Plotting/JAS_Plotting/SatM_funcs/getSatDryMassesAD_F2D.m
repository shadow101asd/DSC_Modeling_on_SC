function [m_dry_persat, TOD, exitflag] = getSatDryMassesAD_F2D(aFLO,eFLO,NM,Nw,mu,NL,Npl,f,Shuttle_Isp,Sat_Isp,Shuttle_wetMass,Shuttle_dryMass,maxShuttlePayload)
% Units
% Outputs:
% m_dry_persat - [kg]
...
% Compute satellite insertion DV - force transfer to apoapsis
[Sat_DV, Sat_TOF] = computeHohmannTransferCirc2Ell(RD,aFLO,eFLO,mu,"apoapsis");
