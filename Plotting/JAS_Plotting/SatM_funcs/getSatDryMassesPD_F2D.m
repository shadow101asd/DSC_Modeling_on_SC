function [m_dry_persat, TOD, exitflag] = getSatDryMassesPD_F2D(aFLO,eFLO,NM,Nw,mu,NL,Npl,f,Shuttle_Isp,Sat_Isp,Shuttle_wetMass,Shuttle_dryMass,maxShuttlePayload)
% Units
% Outputs:
% m_dry_persat - [kg]
...
% Compute satellite insertion DV - force transfer to periapsis
[Sat_DV, Sat_TOF] = computeHohmannTransferCirc2Ell(RD,aFLO,eFLO,mu,"periapsis");
...
TOD_seconds = Shuttle_TOF + T_between_sats * (Nsats-1) + Sat_TOF; % Total deployment time, seconds
