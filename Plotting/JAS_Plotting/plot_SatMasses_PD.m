...
% Using the Periapsis Insertion Strategy
...
parfor i = 1:NA
    for j = 1:NE
        aFLO = aFs(i);
        eFLO = eFs(j);
        [m_dry_persat, TOD, exitflag] = getSatDryMassesPD_F2D(aFLO,eFLO,NM,Nw,muSu,NL,Npl,f,Shuttle_specs.Isp,Sat_Isp,Shuttle_specs.wetMass,Shuttle_specs.dryMass,Shuttle_specs.maxPayload)
...
filename1 = "./Figures/SatMass_HeatMap_PeriDeployment.eps";
exportgraphics(f1, filename1);

% filename2 = "./Figures/TOD_HeatMap_PeriDeployment.eps";
