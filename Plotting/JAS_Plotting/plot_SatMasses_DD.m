...
% Using the Direct Insertion Strategy
...
parfor i = 1:NA
    for j = 1:NE
        aFLO = aFs(i);
        eFLO = eFs(j);
        [m_dry_persat, TOD, exitflag] = getSatDryMassesDD_F2D(aFLO,eFLO,NM,Nw,muSu,NL,Npl,f,Shuttle_specs.Isp,Sat_Isp,Shuttle_specs.wetMass,Shuttle_specs.dryMass,Shuttle_specs.maxPayload)
...
filename1 = "./Figures/SatMass_HeatMap_DirectDeployment.eps";
