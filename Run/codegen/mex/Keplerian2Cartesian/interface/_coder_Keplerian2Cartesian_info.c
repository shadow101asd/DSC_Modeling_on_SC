 ...
 *
 * _coder_Keplerian2Cartesian_info.c
 *
...
/* Include files */
#include "_coder_Keplerian2Cartesian_info.h"
#include "emlrt.h"
#include "tmwtypes.h"
...
mxArray *emlrtMexFcnProperties(void)
{
  ...
  emlrtSetField(xEntryPoints, 0, "Name",
                emlrtMxCreateString("Keplerian2Cartesian"));
  ...
  emlrtSetField(
      ...
      emlrtMxCreateString("/Users/jpenot/Documents/MATLAB/SC/"
                          "DSC_Modeling_on_SC/Run/Keplerian2Cartesian.m"));
  emlrtSetField(xEntryPoints, 0, "TimeStamp",
                emlrtMxCreateDoubleScalar(739814.73638888891));
...
/* End of code generation (_coder_Keplerian2Cartesian_info.c) */
