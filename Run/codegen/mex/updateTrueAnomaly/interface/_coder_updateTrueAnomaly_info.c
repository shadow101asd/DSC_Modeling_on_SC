 ...
 *
 * _coder_updateTrueAnomaly_info.c
 *
...
/* Include files */
#include "_coder_updateTrueAnomaly_info.h"
#include "emlrt.h"
#include "tmwtypes.h"
...
mxArray *emlrtMexFcnProperties(void)
{
  ...
  emlrtSetField(xEntryPoints, 0, "Name",
                emlrtMxCreateString("updateTrueAnomaly"));
...
/* End of code generation (_coder_updateTrueAnomaly_info.c) */
