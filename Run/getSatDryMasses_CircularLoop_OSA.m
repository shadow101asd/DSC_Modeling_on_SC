function [m_dry_per_sat, exitflag] = getSatDryMasses_CircularLoop_OSA(Rf,mu,NSats,Shuttle_Isp,Sat_Isp,Shuttle_wetMass,Shuttle_dryMass,maxShuttlePayload, maxO)
    % Constants
    ...
    [~, ~, DV1, DV2] = computeHohmannTransferCirc2Circ(AU, Ro, mu);
    vinf = abs(DV1);
    ...
    [sat_DV, ~, ~, ~] = computeHohmannTransferCirc2Circ(Ro, Rf, mu); % km/s
