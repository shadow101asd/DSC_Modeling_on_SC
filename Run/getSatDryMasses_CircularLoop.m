function [Sats_DryMasses, mode, exitflag, mpersat_under, mpersat_over, mpersat_phasing] = getSatDryMasses_CircularLoop(Rf,mu,NSats,Shuttle_Isp,Sat_Isp,Shuttle_wetMass,Shuttle_dryMass,maxShuttlePayload, maxO)
...
mpersat_phasing = getSatDryMasses_CircularLoop_PA(Rf,mu,NSats,Shuttle_Isp,Sat_Isp,Shuttle_wetMass,Shuttle_dryMass,maxShuttlePayload, maxO);
