function [Sats_MOGMs, Shuttle_FE, Sat_FEs, leftoverShuttle_FM, exitflag] = getSatDryMasses2BI(aMOG,eMOG,mu,NSats,Shuttle_Isp,Sat_Isp,Shuttle_wetMass,Shuttle_dryMass,maxShuttlePayload)
...
% % Find DVs
% 
% [SS_DV, MOGSat_DV, ~, ~, ~, ~] = computeMOGDVs1(aMOG,eMOG,mu);
% 
...
[~, MOGSat_DV, ~, ~, ~, ~] = computeMOGDVs1(aMOG,eMOG,mu);
MOGSat_DV = MOGSat_DV*10^3; % convert km/s to m/s
